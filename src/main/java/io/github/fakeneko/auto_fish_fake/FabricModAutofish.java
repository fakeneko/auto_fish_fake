...
import io.github.fakeneko.auto_fish_fake.config.Config;
import io.github.fakeneko.auto_fish_fake.config.ConfigManager;
import io.github.fakeneko.auto_fish_fake.gui.AutofishScreenBuilder;
import io.github.fakeneko.auto_fish_fake.scheduler.AutofishScheduler;

public class FabricModAutofish {
    private static FabricModAutofish instance;
    private AutoFishFakeneko autofish;
    ...
    public void onInitializeClient() {
        ...
        this.autofish = new AutoFishFakeneko(this);
